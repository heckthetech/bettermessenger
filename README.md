...
A browser extension that transforms `facebook.com/messages` to look, work, and behave exactly like the standalone Messenger web app (`messenger.com/t`) by removing Facebook’s header and navigation and adding features not available in Facebook™ version of Messenger.
